...
module DataMemory(Address, WriteData, Clk, MemWrite, MemRead, ReadData, LoadStoreByte, LoadStoreHalf); 
    ...
    always@(posedge Clk)begin   //, MemRead
        ...
        if(MemWrite == 1'b1) begin
            if(LoadStoreByte == 1'b1 && LoadStoreHalf == 1'b0) memory[Address[12:2]][7:0] = WriteData[7:0];
            else if(LoadStoreHalf == 1'b1 && LoadStoreByte == 1'b0) memory[Address[12:2]][15:0] = WriteData[15:0];
            else memory[Address[12:2]] = WriteData;
        end
    end
    ...
    always@(MemRead or Address)begin        
       ...
       if(MemRead == 1'b1) begin
            if(LoadStoreByte == 1'b1 && LoadStoreHalf == 1'b0) ReadData <= {{24{memory[Address[12:2]][7]}}, memory[Address[12:2]][7:0]};
            else if(LoadStoreHalf == 1'b1 && LoadStoreByte == 1'b0) ReadData <= {{16{memory[Address[12:2]][15]}}, memory[Address[12:2]][15:0]};
            else ReadData <= memory[Address[12:2]];
        end
